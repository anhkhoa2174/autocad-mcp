...
class FileIPCBackend(AutoCADBackend):
    ...
    async def _dispatch_unlocked(self, command: str, params: dict) -> CommandResult:
        ...
        try:
            ...
            # ensure_ascii=False keeps Unicode chars as-is (e.g., ² stays as ²
            # not ²). LISP JSON parser doesn't decode \u escapes, so without
            # this flag, text containing Unicode renders as literal "²".
